...
public:
   BoardClass(const std::string &n, Object *(*c)(), const std::string &fn, 
    // ATTN: NOT SURE IF CORRECT Parameter to initialize the mViewClass member
    const Class *myViewClass,
    // ATTN: NOT SURE IF CORRECT Parameter to initialize the mDlgClass member
    const Class *myDlgClass,
    // ATTN: NOT SURE IF CORRECT Function pointer parameter to the mutator for the options
   void (*setOptions)(const void*),
    // ATTN: NOT SURE IF CORRECT Function pointer parameter to the accessor for the options
   void *(*getOptions)(),
...
protected:
   ...
   // ATTN: NOT SURE IF CORRECT Ptr to option mutator
   void (*mSetOptions)(const void *);
   // ATTN: NOT SURE IF CORRECT Pointer to option accessor
   void *(*mGetOptions)();
   bool mUseXPos;
